...
class ConvLSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, num_layers,
                 n_classes, seq_len, bias=True, return_all_layers=False):
        ...
        self.fc = nn.Linear(self.seq_len, self.n_classes)
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        if hidden_state is not None:
            ...
            # Since the init is done in forward. Can send sequence length here
        ...
        output = layer_output_list[0].reshape(-1, t_size*self.hidden_dim, self.seq_len)
